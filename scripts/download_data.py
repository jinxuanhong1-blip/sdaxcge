...
1. TCGA-READ RNA-seq gene-expression matrix from the UCSC Xena TCGA hub
   (dataset ``TCGA.READ.sampleMap/HiSeqV2``). Values are log2(norm_count + 1),
   ...
   focus genes (TACSTD2, CLDN4) directly addressable. This is the same hub
   and pipeline as the B1_BRCA analog.
...
EXPRESSION_URL = (
    ...
    "download/TCGA.READ.sampleMap%2FHiSeqV2.gz"
)
EXPRESSION_FILE = DATA_DIR / "TCGA-READ.HiSeqV2.gz"
