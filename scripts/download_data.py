...
1. TCGA-CESC RNA-seq gene-expression matrix from the UCSC Xena TCGA hub
   (dataset ``TCGA.CESC.sampleMap/HiSeqV2``). Values are log2(norm_count + 1),
   ...
   focus genes (TACSTD2, CLDN4) directly addressable. This is the same Xena
   HiSeqV2 family used by the BRCA B1 analog.
...
EXPRESSION_URL = (
    ...
    "download/TCGA.CESC.sampleMap%2FHiSeqV2.gz"
)
EXPRESSION_FILE = DATA_DIR / "TCGA-CESC.HiSeqV2.gz"
