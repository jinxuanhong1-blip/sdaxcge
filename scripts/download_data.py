...
1. TCGA-STAD RNA-seq gene-expression matrix from the UCSC Xena TCGA hub
   (dataset ``TCGA.STAD.sampleMap/HiSeqV2``). Values are log2(norm_count + 1),
...
EXPRESSION_URL = (
    ...
    "download/TCGA.STAD.sampleMap%2FHiSeqV2.gz"
)
EXPRESSION_FILE = DATA_DIR / "TCGA-STAD.HiSeqV2.gz"
