#!/usr/bin/env python3
"""Download public GSE285029 author WTS matrix + series matrix."""
...
FILES = {
    ...
    "GSE285029_series_matrix.txt.gz": (
        "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE285nnn/GSE285029/"
        "matrix/GSE285029_series_matrix.txt.gz"
    ),
}
...
def fetch(url: str, dest: Path) -> None:
    ...
    if dest.exists() and dest.stat().st_size > 0:
        ...
        return
    print(f"GET {url}")
    req = urllib.request.Request(url, headers={"User-Agent": "A11-GSE285029/1.0"})
