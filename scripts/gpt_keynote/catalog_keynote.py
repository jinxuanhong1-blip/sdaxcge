...
CATALOG = [
    ...
    {
        "record": "KEYNOTE-024",
        "trial": "KEYNOTE-024 / NCT02142738",
        "lung_scope": "yes (NSCLC)",
        "assay_or_data": "PD-L1 IHC; no public transcriptomic analysis located",
        "processed_patient_level_matrix": "not found",
        "access": "controlled/on-request",
        "downloaded": "no",
        "tacstd2": "not assessable",
        "cldn4": "not assessable",
        "evidence": "https://doi.org/10.1200/JCO.21.00174",
        "honest_note": "No open RNA-seq, NanoString, or count accession was located.",
    },
    {
    ...
    {
        "record": "KEYNOTE-598",
        "trial": "KEYNOTE-598 / NCT03302234",
        "lung_scope": "yes (NSCLC)",
        "assay_or_data": "reported molecular follow-up uses plasma ctDNA WGS/WES, not RNA",
        "processed_patient_level_matrix": "not found (not an RNA analysis)",
        "access": "controlled/on-request; aggregate reports open",
        "downloaded": "no",
        "tacstd2": "not assessable as expression",
        "cldn4": "not assessable as expression",
        "evidence": "https://doi.org/10.1158/1538-7445.AM2024-3664",
        "honest_note": "No open transcriptomic accession or processed expression matrix was located.",
    },
    {
        "record": "KEYNOTE-782",
    ...
    },
    {
        ...
        "honest_note": (
            "This is controlled access, not open data; current MSD procedure says "
            "participant-level genetic/exploratory biomarker data are not shared directly."
        ),
    },
    {
        "record": "dbGaP phs001572",
        "trial": "KEYNOTE-001/-006/-012/-028 pan-tumor subsets",
        "lung_scope": "includes a small-cell-lung indication, but not a lung expression matrix",
        "assay_or_data": "authorized-access WES; no deposited RNA/NanoString matrix",
        "processed_patient_level_matrix": "no",
        "access": "controlled dbGaP",
        "downloaded": "no",
        "tacstd2": "not assessable as expression",
        "cldn4": "not assessable as expression",
        "evidence": "https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=phs001572.v1.p1",
        "honest_note": "A cross-catalog EGA page does not make this dbGaP study anonymously downloadable.",
    },
    {
