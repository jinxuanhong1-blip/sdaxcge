#!/usr/bin/env python3
"""Fetch GEO series metadata (esummary) for candidate UIDs and store as a table.

For each gds UID we record the real GSE accession, title, summary, organism,
sample count, submission/last-update dates, gdsType, PubMed IDs, and the
supplementary-file listing (FTP link + suppFile field). No IDs are invented;
every accession comes straight from NCBI esummary.
"""
import json
import time
import sys
...
OUT_DIR = ROOT / "results" / "fable_geo_2019_2021"
