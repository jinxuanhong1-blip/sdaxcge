#!/usr/bin/env python3
"""Download public GSE22493 files and the NCBI human gene_info table.

GEO objects are open FTP files. gene_info supplies current HGNC symbols
and synonyms for the remap. Nothing here is controlled-access.

Override the cache directory with NHEJ_STING_GSE22493_DATA.
"""
