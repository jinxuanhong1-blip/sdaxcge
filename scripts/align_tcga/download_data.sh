...
echo "[3/5] TCGA tumour purity (Aran et al. Nat Commun 2015, Supp Data 1) ..."
...
echo "[4/5] GSE248378 post-treatment FPKM (Altorki neoadjuvant durvalumab) ..."
curl -fsSL -o GSE248378_Durva_Post_FPKMs.txt.gz \
  "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE248nnn/GSE248378/suppl/GSE248378_Durva_Post_FPKMs.txt.gz"

echo "[5/5] GSE253564 pre-treatment FPKM (same trial) ..."
curl -fsSL -o GSE253564_Pre-treatment_Samples_Pubs_FPKMs.txt.gz \
  "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE253nnn/GSE253564/suppl/GSE253564_Pre-treatment_Samples_Pubs_FPKMs.txt.gz"
