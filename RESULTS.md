...
![Patient-level Spearman ρ](results/cosmx_cldn4_ifn_stat1/figures/patient_forest.png)
...
- `results/cosmx_cldn4_ifn_stat1/tables/patient_summary.tsv` — patient means used above
- `results/cosmx_cldn4_ifn_stat1/tables/section_correlations.tsv` — per section
- `results/cosmx_cldn4_ifn_stat1/tables/depth_within_fov.tsv`, `tables/depth_summary.json`
- `results/cosmx_cldn4_ifn_stat1/tables/neighbor_library.tsv`, `tables/perm_positive_tail.json`
- `results/cosmx_cldn4_ifn_stat1/tables/gene_spearman.tsv`, `tables/panel_inventory.json`, `tables/summary.json`
- `results/cosmx_cldn4_ifn_stat1/figures/patient_forest.png`, `figures/gene_spearman.png`
