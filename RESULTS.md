...
![Requested genes on the CTA panel](results/gse221733_geomx/figures/panel_requested_genes.png)

![CLDN4 tests skipped](results/gse221733_geomx/figures/cldn4_tests_skipped.png)
...
Full checklist: `results/gse221733_geomx/tables/panel_inventory.csv`.
...
![AOI inventory](results/gse221733_geomx/figures/aoi_inventory.png)
...
![Pairing availability](results/gse221733_geomx/figures/pairing_availability.png)
...
![ICB response labels](results/gse221733_geomx/figures/response_labels.png)

![AOI area vs nuclei](results/gse221733_geomx/figures/aoi_area_nuclei.png)
...
| File | Contents |
|---|---|
| `results/gse221733_geomx/stats.txt` | Key counts |
| `results/gse221733_geomx/provenance.json` | GEO URLs and dump of `stats` |
| `results/gse221733_geomx/tables/panel_inventory.csv` | Requested genes vs panel |
| `results/gse221733_geomx/tables/aoi_metadata.csv` | 93 AOIs, QC, response, in-norm flag |
| `results/gse221733_geomx/tables/pairing_summary.csv` | Same-ROI tumor/stroma pairing |
| `results/gse221733_geomx/tables/tests_not_run.csv` | Asked tests and skip reasons |
| `results/gse221733_geomx/figures/` | Panel, AOI inventory, pairing, labels, QC |
