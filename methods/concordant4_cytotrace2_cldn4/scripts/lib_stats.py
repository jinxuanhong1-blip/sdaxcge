#!/usr/bin/env python3
"""Patient-level Spearman helpers and DerSimonian–Laird pooling.

Same Fisher-z random-effects estimator as the concordant-4 T/NK meta.
"""
...
def random_effects_dl(rhos: list[float], ns: list[int]) -> dict:
    ...
    kept_rho = [r for r, keep in zip(rhos, ok) if keep]
