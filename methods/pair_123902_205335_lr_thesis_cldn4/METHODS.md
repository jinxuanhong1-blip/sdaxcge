# Methods — thesis-aligned CLDN4-only ligand families (GSE123902 + GSE205335)
...
PR #459 pair that differs: GSE123902+GSE205335 %pos n=35, ρ=−0.522, Q4 vs Q1 r=−0.802.
...
- GSE205335 `GSE205335_Lung_IO_UMI_matrix.rds.gz` + author cell identity.
  FASTQ / EGA / SRA are skipped.
...
- GSE205335: author `lineage.sub` == Malignant cells;
  T/NK = author `lineage.total` == T/NK cells. Locked patients only.
