...
def write_finding(tnk: dict, cellchat: dict | None, out: Path) -> None:
    ...
    lines = [
        ...
        "## Honest n",
        "",
        f"- GSE131907 (Kim et al. 2020): tumor-origin author malignant/tS* with",
        f"  ≥{MIN_MAL_131907} malignant **and** ≥{MIN_TNK_131907} T/NK. After the",
        f"  floor this is **{n131} patients** (one tumor-origin sample each;",
