...
Same engine as methods/gse68465_cldn4_gsea/gsea_core.py. Gene-set permutation,
not sample permutation. NES sign follows the supplied rank: positive means
the set is enriched at the high-score end of that rank. This file does not
decide whether the high-score end is CLDN4-low or CLDN4-high.
"""
