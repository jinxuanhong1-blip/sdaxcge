...
def main() -> int:
    ...
    ap.add_argument("--extracted", type=Path, default=EXTRACTED / "GSE253013")
    args = ap.parse_args()
    ex = args.extracted
    ...
    meta["dataset"] = "GSE253013"
    meta["site"] = meta["tissue"] if "tissue" in meta.columns else "Tumor"
    if "cell_type" in meta.columns:
        meta["author_cell_type"] = meta["cell_type"].astype(str)
    else:
        meta["author_cell_type"] = ""
    meta["author_subtype"] = ""
