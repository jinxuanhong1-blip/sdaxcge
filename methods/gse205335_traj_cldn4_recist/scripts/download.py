#!/usr/bin/env python3
"""Download public processed UMIs for GSE205335 only.

No EGA/FASTQ. No GSE148071. No GSE131907. No dual-high inputs.
"""
...
def main() -> None:
    ...
    p.add_argument("--out", type=Path, default=Path("/tmp/gse205335_traj"))
    args = p.parse_args()
