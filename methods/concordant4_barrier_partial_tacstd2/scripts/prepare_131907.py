#!/usr/bin/env python3
"""Column map for GSE131907. Malignant and T/NK from locked samples.

Adds TACSTD2 to the gene request. Labels match the CellChat inventory.
"""
...
GENES = [
    "EPCAM", "KRT8", "KRT18", "KRT19", "PTPRC", "CD3D", "CD3E", "CD8A", "NKG7",
    "GNLY", "KLRD1", "CLDN4", "TACSTD2", "F11R", "JAM1", "NECTIN2", "PVRL2",
    "CDH1", "LGALS9", "ITGAL", "ITGB2", "TIGIT", "CD96", "ITGAE", "ITGB7",
    "KLRG1", "HAVCR2", "CD44",
]
