...
Copied from the GSE289287 xenograft prerank (methods/gse289287_trop2ko_gsea).
Gene-set permutation, not sample permutation. Positive NES = enriched at the
high end of the ranking (here, Trop-2 KO).
