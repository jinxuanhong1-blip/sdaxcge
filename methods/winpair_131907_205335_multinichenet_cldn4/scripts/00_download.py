#!/usr/bin/env python3
"""Download public winning-pair matrices and NicheNet-v2 priors.

GSE131907 + GSE205335 only. GSE207422 is not fetched (PR #334 NS).
EGA raw FASTQ is not accessed. nichenetr / multinichenetr are not required.
"""
...
def main() -> int:
    ...
    skip = DATA / "SKIPPED.txt"
    skip.write_text(
        "GSE207422 not downloaded (PR #334 NS; do not redo).\n"
        "GSE253013 not downloaded.\n"
        "EGAD00001005054 (GSE131907 raw) not accessed.\n"
        "EGAD00001008703 (GSE205335 raw) not accessed.\n"
        "nichenetr / multinichenetr not installed; v2 ligand-target prior used.\n"
    )
    print("ok", flush=True)
    return 0
