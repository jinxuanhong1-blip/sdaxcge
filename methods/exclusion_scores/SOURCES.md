...
| Spatial CD8 IES | Sher et al., SITC 2024 abstract 574, DOI [10.1136/jitc-2024-SITC2024.0574](https://doi.org/10.1136/jitc-2024-SITC2024.0574) | Bessede-coauthored poster related IES to DDR1, not TACSTD2. Exact log base, pseudocount, area rules and sign were not published. `score_spatial_ies.py` is explicitly marked as a reconstruction and must not be described as author-exact. |
...
| 2024 | Spatial CD8 immune exclusion | Sher et al., SITC abstract 574, DOI [10.1136/jitc-2024-SITC2024.0574](https://doi.org/10.1136/jitc-2024-SITC2024.0574) | Compartmental mIF IES associated with outcome and DDR1. No direct TACSTD2 test; RNA signature genes and exact IES implementation were not disclosed. |
