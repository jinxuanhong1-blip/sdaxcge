#!/usr/bin/env python3
"""Download CPTAC LUAD and LSCC public TMT + RNA + phenotype (freeze v1.2).

Open S3 only. Filenames from the LinkedOmics CPTAC-pancan index, confirmed
HTTP 200. No dbGaP / CDS tokens. Files >2 GB would be skipped.
"""
...
def main() -> int:
    ...
    p.add_argument("--outdir", default="data/cptac_cldn4_q4")
    args = p.parse_args()
    ...
    manifest = {
        ...
        "scope": "CLDN4 protein Q4 vs Q1; LUAD + LSCC public TMT only",
