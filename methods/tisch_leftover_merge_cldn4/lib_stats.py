#!/usr/bin/env python3
"""Spearman, Q4 vs Q1, DerSimonian–Laird, Stouffer helpers (CLDN4-only)."""
...
def q4_vs_q1(cldn4, immune) -> dict | None:
    """Within-vector CLDN4 quartiles; MWU on immune. r_rb < 0 = Q4 immune lower."""
