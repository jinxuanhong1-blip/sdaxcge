#!/usr/bin/env python3
"""Stream GSE207422 genes×cells UMI; keep CLDN4, lineage, B/TLS genes.
...
WANTED = [
    ...
    "IFNG",
    "MKI67",
    # Coppola / 12-chemokine TLS signature
    "CCL2",
    "CCL3",
    "CCL4",
    "CCL5",
...
def main() -> None:
    ...
    out = args.workdir / "extracted_cldn4_bfrac_markers.npz"
    wanted = set(WANTED)
