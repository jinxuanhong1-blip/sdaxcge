#!/usr/bin/env python3
"""Stream selected genes and full-library sizes from the GSE131907 UMI matrix.

Writes a compact npz. Does not load the full gene x cell matrix.
"""
...
def main() -> None:
    ...
    ap.add_argument("--outdir", type=Path, default=Path("/tmp/gse131907/mpe_axis"))
    args = ap.parse_args()
    ...
    meta = {
        ...
        "min_nCount_full": float(libsize.min()),
        "source": matrix.name,
