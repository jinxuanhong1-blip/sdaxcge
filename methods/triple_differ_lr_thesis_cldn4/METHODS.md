# Methods — thesis-aligned CLDN4-only ligand families (triple that differs)

ADDITIVE. CLDN4 only. No dual-high. No GSE148071. No 7-pool.
Patient/donor/locked-sample is the unit. The PR #459 %pos Spearman is not re-audited.

## Given cut

PR #459 triple that differs: GSE123902+GSE131907+GSE205335 %pos n=56,
ρ=−0.522, Q4 vs Q1 r=−0.735 (14 vs 14).
Locked units: `data/GSE123902_marker_units.tsv` (donor, n=13),
`data/GSE131907_samples.tsv` (sample, n=21 with author malignant + T/NK),
`data/GSE205335_patients.tsv` (patient, n=22).
...
- GSE205335 UMI RDS + CellIdentity + family SOFT (Hu 2023). No EGA raw.
...
CellChat R, LIANA, dual-high, GSE148071, 7-pool, T/NK rho re-audit, cell-pooled tests.
