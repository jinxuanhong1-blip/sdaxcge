...
Thesis (already correct; this folder tests it on the PR #459 triple that differs):
...
def thesis_genes() -> set[str]:
    ...
    # subunits that CellChatDB may spell differently
    genes.update(
        {
            "F11R",
            "ITGAL",
