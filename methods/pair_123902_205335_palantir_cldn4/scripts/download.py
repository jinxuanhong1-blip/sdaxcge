#!/usr/bin/env python3
"""Download GSE123902 + GSE205335 processed files only.

ADDITIVE. No GSE148071. No 7-cohort pool. No FASTQ / EGA / SRA.
...
def main() -> None:
    ...
    ap.add_argument("--outdir", type=Path, default=Path("/tmp/pair_123902_205335_palantir"))
    args = ap.parse_args()
    ...
    print("skipped GSE148071. skipped 7-cohort pool.", flush=True)
