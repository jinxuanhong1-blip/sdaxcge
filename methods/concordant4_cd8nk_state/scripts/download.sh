...
echo "GSE205335 UMI RDS is double-gzipped. Unpack before export_gse205335.R:"
echo "  gzip -dc $OUT/GSE205335/GSE205335_Lung_IO_UMI_matrix.rds.gz | gzip -dc > $OUT/GSE205335/GSE205335_Lung_IO_UMI_matrix.rds"
