...
Integrate public [GSE165641](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE165641) + [GSE180963](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE180963) KL/K GEMM 10x. **R + Seurat** (`CreateSeuratObject` per dataset) then **Harmony** via `IntegrateLayers`. Cldn4-only. Honest n = mice after merge. See `FINDING.md`.
