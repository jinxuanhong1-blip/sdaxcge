...
Neither series deposits OS. See `../playbook.md` §9 for why these numbers cannot establish a biomarker, and §10 for why OAK/POPLAR are the right next dataset and are not used here.
