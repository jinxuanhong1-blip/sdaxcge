#!/usr/bin/env python3
"""GEO GSE148071 raw UMI → TISCH-labeled malignant-like epithelium AnnData.

Keeps TISCH2 Malignant + leftover epithelium (Alveolar / Basal / Epithelial).
Counts come from the public GSE148071_RAW.tar (42 sample UMI matrices).
Does not download the 1.1 GB TISCH expression.h5.
"""
...
def main() -> None:
    ...
    ap.add_argument("--data", default="/tmp/gse148071_sling_data")
    ap.add_argument("--out", default="/tmp/gse148071_sling_data/epithelium.h5ad")
    args = ap.parse_args()
