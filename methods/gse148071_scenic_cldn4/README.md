...
See [`FINDING.md`](FINDING.md) and [`results/primary_table.tsv`](results/primary_table.tsv).

**Honest n = 38** (42 deposited; P37 occupancy; P4/P11/P42 no CLDN4 split). TJ regulon AUCell is higher in CLDN4-high (37/38). IFN regulon is modestly higher (30/38). MHC CIITA/RFX regulons are null (17/38).
