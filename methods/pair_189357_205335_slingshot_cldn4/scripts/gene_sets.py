"""Locked gene sets for GSE189357+GSE205335 CLDN4-only Slingshot/PAGA.

CLDN4 is the readout. It is NOT in the barrier/keratin or IFN scores.
TACSTD2 is a comparator only — no dual-high gate.
IFN = Hallmark IFNα ∩ IFNγ (Liberzon 2015 / Enrichr MSigDB Hallmark 2020).
"""
...
STATES = {
    ...
    # Hallmark IFNα ∩ IFNγ. CLDN4 is not a member.
    "IFN": (
        "ADAR",
        "B2M",
        "BATF2",
