...
> **Not skipped.** The full author-processed supplement was downloaded and analyzed:
> `GSE205335_Lung_IO_UMI_matrix.rds.gz` (499 MB, dgCMatrix, 33,714 genes x 96,505 cells)
> plus `GSE205335_Lung_IO_CellIdentity.txt.gz` (author cell annotations, includes explicit
> "Malignant cells" calls). No raw-data fallback was needed. This directory mirrors
> `results/hunt_gse205335/` (identical files, same analysis run).
