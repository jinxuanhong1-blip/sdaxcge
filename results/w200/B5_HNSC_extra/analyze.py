...
def main() -> None:
    ...
    summary = {
        ...
        "honest_verdict": {
            "label": "SUGGESTIVE_CLDN4_NOT_MULTIPLICITY_SIGNIFICANT",
            ...
            "statement": (
                ...
                "In the only analyzed full-transcriptome leftover, GSE179730 (n=11), lower CLDN4 "
                "in the clinical-benefit group is nominally suggestive (exact p=0.045) but does not "
                "survive correction across the two markers (q=0.091); TACSTD2 is null. Expression "
                "is sparse and the cohort is too small for validation."
            ),
        },
    }
